"""
Gestión de Base de Datos para el Sistema de Vigilancia
"""
...
class Evento(Base):
    ...
    tipo_evento = Column(String(50))      # 'merodeo', 'movimiento_sospechoso', etc.
...
def guardar_evento(datos_evento):
    ...
    Args:
        datos_evento: Diccionario con datos del evento
